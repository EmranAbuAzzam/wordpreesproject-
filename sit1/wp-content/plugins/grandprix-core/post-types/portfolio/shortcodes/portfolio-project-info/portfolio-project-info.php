...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'grandprix-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'grandprix-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'grandprix-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'grandprix-core' ),
							'value'       => array(
								esc_html__( 'Title', 'grandprix-core' )          => 'title',
								esc_html__( 'Category', 'grandprix-core' )       => 'category',
								esc_html__( 'Tag', 'grandprix-core' )            => 'tag',
								esc_html__( 'Author', 'grandprix-core' )         => 'author',
								esc_html__( 'Date', 'grandprix-core' )           => 'date',
								esc_html__( 'Featured Image', 'grandprix-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'grandprix-core' ),
							'value'       => array_flip( grandprix_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'grandprix-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'grandprix-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'grandprix-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'grandprix-core' ),
							'value'      => array_flip( grandprix_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
