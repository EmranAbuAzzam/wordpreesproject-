<div class="mkdf-section-title-holder <?php echo esc_attr( $holder_classes ); ?>" <?php echo grandprix_mikado_get_inline_style( $holder_styles ); ?>>
	...
	<?php } ?>
		<?php if ( ! empty( $title ) ) { ?>
			<<?php echo esc_attr( $title_tag ); ?> class="mkdf-st-title" <?php echo grandprix_mikado_get_inline_style( $title_styles ); ?>>
				<?php if ( $type === 'split'  ) { ?>
		...
		<?php } ?>
		<?php if ( ! empty( $text ) ) { ?>
			<<?php echo esc_attr( $text_tag ); ?> class="mkdf-st-text" <?php echo grandprix_mikado_get_inline_style( $text_styles ); ?>>
