<div class="mkdf-animated-text-holder <?php echo esc_attr( $holder_classes ); ?>">
	<<?php echo esc_attr( $text_tag ); ?> class="mkdf-animated-text" <?php grandprix_mikado_inline_style( $text_styles ); ?> <?php echo grandprix_mikado_get_inline_attrs( $text_data ); ?> >
