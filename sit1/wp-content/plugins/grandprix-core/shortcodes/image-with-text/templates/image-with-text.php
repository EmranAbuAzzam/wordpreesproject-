    ...
    <div class="mkdf-iwt-text-holder">
	    ...
	    <?php if(!empty($title)) { ?>
		    <?php if (!empty($custom_link)) { ?>
		        <a itemprop="url" href="<?php echo esc_url($custom_link); ?>" target="<?php echo esc_attr($custom_link_target); ?>">
			        <<?php echo esc_attr($title_tag); ?> class="mkdf-iwt-title" <?php echo grandprix_mikado_get_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
			    </a>
		    <?php } else {?>
	    <<?php echo esc_attr($title_tag); ?> class="mkdf-iwt-title" <?php echo grandprix_mikado_get_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
		    <?php } ?>
