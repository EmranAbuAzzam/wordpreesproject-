<?php
if ( ! function_exists( 'grandprix_mikado_init_google_fonts_array' ) ) {
    function grandprix_mikado_init_google_fonts_array() {
...
';
        ...
        $grandprix_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'grandprix_mikado_init_google_fonts_array');
}