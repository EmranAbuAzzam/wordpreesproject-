...
/**
 * Class GrandPrixInstagramHelper
 */
class GrandPrixInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines grandprix_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'grandprix_instagram_image_atts',
			array(
