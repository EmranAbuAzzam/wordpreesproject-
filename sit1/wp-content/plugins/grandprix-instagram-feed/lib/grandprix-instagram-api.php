...
include 'grandprix-instagram-helper.php';

/**
 * Class GrandPrixInstagramApi
 */
class GrandPrixInstagramApi {
	...
	const INSTAGRAM_CODE = 'grandprix_instagram_code';
	const INSTAGRAM_USER_ID = 'grandprix_instagram_user_id';
	const INSTAGRAM_TOKEN = 'grandprix_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'grandprix_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'grandprix_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'grandprix_facebook_code';
	const FACEBOOK_TOKEN = 'grandprix_facebook_access_token';

	const CONNECTION_TYPE = 'grandprix_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new GrandPrixInstagramHelper();
	}

	/**
	 * @return GrandPrixInstagramApi
	 */
	...
	/**
	 * @return GrandPrixInstagramHelper
	 */
	 ...
	 *
	 * @see GrandPrixInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see GrandPrixInstagramApi::instagramExchangeCodeForToken()
	 */
