<div class="mkdf-instagram-list-holder <?php echo esc_attr($holder_classes); ?>" <?php echo grandprix_mikado_get_inline_attrs( $data_attr ) ?>>
    ...
    <?php } else { ?>
        <div class="mkdf-instagram-not-connected">
            <?php esc_html_e( 'It seams that you haven\'t connected with your Instagram account', 'grandprix-instagram-feed' ); ?>
        </div>
    <?php } ?>
</div>
